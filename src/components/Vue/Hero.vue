    ...
    <div class="max-w-7xl mx-auto">
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="text-left space-y-6">
          <Transition appear enter-active-class="transition duration-1000 delay-200"
            enter-from-class="opacity-0 -translate-x-12" enter-to-class="opacity-100 translate-x-0">
            <h1
              class="text-5xl md:text-6xl font-bold bg-gradient-to-br from-teal-300 via-emerald-400 to-cyan-400 bg-clip-text text-transparent leading-tight">
              Vue + Astro:<br />
              <span class="text-4xl md:text-5xl">Where Innovation Meets Speed</span>
            </h1>
          </Transition>

          <Transition appear enter-active-class="transition duration-1000 delay-400"
            enter-from-class="opacity-0 -translate-x-8" enter-to-class="opacity-100 translate-x-0">
            <p class="text-xl text-gray-300 leading-relaxed">
              Experience the perfect blend of Vue's reactivity and Astro's performance. Build faster, smoother, and more
              engaging web applications.
            </p>
          </Transition>

          <Transition appear enter-active-class="transition duration-1000 delay-600"
            enter-from-class="opacity-0 -translate-y-8" enter-to-class="opacity-100 translate-y-0">
            <div class="flex gap-4">
              <button @click="() => activeDemo = (activeDemo % 3) + 1"
          ...
          <Transition appear enter-active-class="transition duration-1000 delay-800"
            enter-from-class="opacity-0 translate-x-12" enter-to-class="opacity-100 translate-x-0">
          ...
          <Transition appear enter-active-class="transition duration-1000 delay-800"
            ...
            <div class="relative">
              ...
              <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 shadow-xl">
                ...
                <Transition mode="out-in" enter-active-class="transition duration-300"
                  enter-from-class="opacity-0 translate-y-4" enter-to-class="opacity-100 translate-y-0"
                  leave-active-class="transition duration-300" leave-from-class="opacity-100 translate-y-0"
                  ...
                  <div :key="activeDemo" class="pt-4 mt-2">
                    ...
                    <div v-if="activeDemo === 1" class="space-y-4">
                      ...
                      <div class="flex items-center gap-4">
                        <button @click="count--"
                          class="px-4 py-2 rounded bg-gray-700/50 hover:bg-gray-700 transition-colors">-</button>
                    ...
                    <div v-if="activeDemo === 2" class="space-y-4">
                      ...
                      <div class="space-y-2">
                        ...
                        <div class="h-24 rounded-lg transition-colors duration-300"
                          :style="{ backgroundColor: `hsl(${hue}, 70%, 50%)` }"></div>
              ...
              <!-- Decorative Elements -->
              <div
                class="absolute -bottom-4 -right-4 w-24 h-24 bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 rounded-full blur-xl">
              </div>
              <div
                class="absolute -top-4 -left-4 w-32 h-32 bg-gradient-to-br from-teal-500/20 to-emerald-500/20 rounded-full blur-xl">
              </div>
            </div>
          </Transition>
        </div>
